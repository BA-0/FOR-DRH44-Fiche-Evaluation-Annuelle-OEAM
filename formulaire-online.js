        ...
        modal.innerHTML = `
            <div style="background-color: white; border-radius: 15px; width: 90%; max-width: 800px; max-height: 90vh; overflow-y: auto; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
                ...
                <div style="padding: 20px 30px; border-top: 2px solid #e0e0e0; text-align: right;">
                    <button onclick="this.closest('div[style*=\"position: fixed\"]').remove(); downloadValidatedPDF(${evaluationId})" style="padding: 12px 25px; background: linear-gradient(135deg, #E30613 0%, #FF3B47 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; margin-right: 10px;">
                        📥 Télécharger le PDF
                    </button>
